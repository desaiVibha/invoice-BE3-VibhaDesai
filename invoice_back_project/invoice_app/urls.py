...
urlpatterns=[
    ...
    path('invoices/<int:invoice_no>/',csrf_exempt(GetInvoiceByID.as_view()),name='get-invoice-by-id'),
    path('invoices/<int:invoice_no>/items',csrf_exempt(AddItem.as_view()),name='add-item')
]